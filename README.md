...
- **Chuẩn bị hàng & in vận đơn**: `services/fulfillment/tiktok.ts` (handover_time_slots → ship package PICKUP/DROP_OFF → tracking → shipping_documents A6 PDF), dùng chung hộp thoại/route với hai sàn kia.
