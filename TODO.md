...
- [x] **24/09/2026 — anh Trung xác nhận ĐÃ CẤT KHÓA DỰ PHÒNG**; cùng ngày anh chốt bật `SECRET_ENC_REQUIRED=1` trên Render (thiếu khóa là máy chủ từ chối khởi động thay vì lặng lẽ ghi chữ thường) — chờ log Render xác nhận `[SecretBox] BẬT` sau deploy.
