...
- [ ] **⏳ ANH TRUNG:** xác nhận đã CẤT KHÓA DỰ PHÒNG ở nơi an toàn thứ hai; vài ngày sau thêm env `SECRET_ENC_REQUIRED=1` trên Render (thiếu khóa là máy chủ từ chối khởi động thay vì lặng lẽ ghi chữ thường). Khi shop đầu tiên nhập tài khoản meInvoice thật: soi cột `meinvoicePassword` trên Supabase phải bắt đầu `enc:v1:k1:`.
